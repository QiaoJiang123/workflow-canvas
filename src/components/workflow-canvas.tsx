  ...
  const edges: Edge[] = useMemo(
    () =>
      workflow.edges.map((edge) => ({
        ...
        source: edge.source,
        target: edge.target,
        sourceHandle: edge.sourceHandle && !["out", "out-right"].includes(edge.sourceHandle) ? edge.sourceHandle : undefined,
        targetHandle: edge.targetHandle && !["in", "in-left"].includes(edge.targetHandle) ? edge.targetHandle : undefined,
        label: edge.label,
